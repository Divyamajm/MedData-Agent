...
[![Test Suite](https://img.shields.io/badge/Test%20Suite-32%2F32%20Passed%20(100%25)-2ea44f?style=for-the-badge&logo=githubactions&logoColor=white)]()
...
<p align="center">
  <b>A deterministic, medically safe, and explainable multi-domain discovery platform centered in India.</b><br/>
  Combines Indian Healthcare Triage (Apollo, Fortis, Manipal in ₹ INR), Indian Real Estate Livability (Bengaluru, Mumbai, Delhi-NCR), and a Universal Dynamic Auto-Schema Profiler for arbitrary datasets.
</p>
...
### Test Results Matrix (32/32 Passing - 100%)
...
| `TC27` | Housing Discovery | *"Find a 3BHK flat under ₹60000 near top schools"* | Multi-filter budget + school rating >= 9.0 | <kbd>✅ PASS</kbd> |
...
| `TC30` | Housing Discovery | *"Luxury Villa in Indiranagar"* | Neighborhood + Villa property type search | <kbd>✅ PASS</kbd> |
| `TC31` | India Localization | *"Find a 3BHK flat in Koramangala under ₹60000"* | Indian locality + INR parsing | <kbd>✅ PASS</kbd> |
| `TC32` | India Localization | *"Find a cardiologist under ₹1500 available today"* | Indian doctor search + ₹ INR fee filter | <kbd>✅ PASS</kbd> |
